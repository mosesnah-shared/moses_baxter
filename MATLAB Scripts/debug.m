...
hold on
% plot( rawdata.time, rawdata.left_s0_q0 )
% plot( rawdata.time, rawdata.left_s1_q0 )
% plot( rawdata.time, rawdata.left_e0_q0 )
% plot( rawdata.time, rawdata.left_e1_q0 )
% plot( rawdata.time, rawdata.left_w0_q0 )
% plot( rawdata.time, rawdata.left_w1_q0 )
% plot( rawdata.time, rawdata.left_w2_q0 )
