...
from my_controllers  import JointPositionController, JointImpedanceController, CartesianImpedanceControllerRotationType1, CartesianImpedanceControllerPosition
...
def main():
    ...
    D1 = 3.0
    impR_1.add_movement( qi = qi, qf = qi, D = D1, ti = 0. )
    ...
    D1 = 3.0
    impL_1.add_movement( qi = qi, qf = qi, D = D1, ti = 0. )
    ...
    # The 3rd impedance for matching the orientation
    impR_3 = CartesianImpedanceControllerRotationType1( my_baxter, which_arm = "right", name = "right_imp3", is_save_data = args.is_save_data )
    impR_3.set_rotational_impedance( k = 10.0, b = 0.5 )
    right_orient = my_baxter.get_end_effector_orientation( which_arm = "right" )
    impR_3.set_desired_orientation( right_orient )
    
    # The 3rd impedance for matching the orientation
    impL_3 = CartesianImpedanceControllerRotationType1( my_baxter, which_arm = "left", name = "left_imp3", is_save_data = args.is_save_data )
    impL_3.set_rotational_impedance( k = 10.0, b = 0.5 )
    left_orient = my_baxter.get_end_effector_orientation( which_arm = "left" )
    impL_3.set_desired_orientation( left_orient )    

    
    # Saving these impedances as an array to iterate over 
    imp_arr  = [ impR_1 , impL_1 ,impR_2 , impL_2 ] #, impR_3, impL_3 ]
